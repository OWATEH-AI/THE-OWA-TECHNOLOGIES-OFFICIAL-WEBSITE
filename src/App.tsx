...
import {
  ...
  Code2, Cpu, Network, TrendingUp, BookOpen, ArrowRight, CheckCircle, Mail, Linkedin, Instagram, Star, MoreHorizontal,
  Facebook, Youtube
} from 'lucide-react';
...
const HeroSlideshow: React.FC = () => {
  ...
  }, [isPaused, heroImages.length, interval]);
...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ===================== HERO ===================== */}
      <section id="hero" style={{ position: 'relative', height: '100vh', display: 'flex', alignItems: 'flex-end', paddingBottom: 80, overflow: 'hidden' }}>
      ...
      <section id="solutions" className="py-24 border-t border-white/10 relative overflow-hidden bg-gradient-to-b from-[#0B0F19] to-[#0A0A0A] reveal-on-scroll">
        ...
        <div className="container relative z-10">
          <motion.div variants={fadeUp} style={{ marginBottom: 72, maxWidth: 600 }}>
      ...
      <section className="py-32 border-t border-white/10 tech-grid-bg" style={{ overflow: 'hidden' }}>
        <div className="container">
          <motion.div variants={fadeUp} style={{ marginBottom: 72, maxWidth: 600 }}>
        ...
        <Marquee>
          {testimonials.map((t, i) => (
            <motion.div
              key={i}
              className={`card-item ${(t as any).isPartner ? 'card-partner' : (t as any).isPromo ? 'card-promo' : ''}`}
              style={{
                width: 440,
                padding: '36px',
                borderRadius: 24,
                ...
                flexShrink: 0,
                display: 'grid',
                gridTemplateColumns: (t as any).image ? '120px 1fr' : '1fr',
                gap: 24,
                height: 320,
                whiteSpace: 'normal',
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div>
                  <div style={{ display: 'flex', gap: 4, marginBottom: 16 }}>
                    {Array.from({ length: t.rating }).map((_, j) => (
                      <Star key={j} size={13} fill={(t as any).isPromo ? "#f97316" : "#fbbf24"} color={(t as any).isPromo ? "#f97316" : "#fbbf24"} />
                    ))}
                  </div>
                ...
                <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 16 }}>
                  <p style={{ fontWeight: 800, fontSize: '0.94rem', color: (t as any).isPartner ? '#60a5fa' : (t as any).isPromo ? '#fb923c' : '#fff', marginBottom: 2 }}>{t.name}</p>
      ...
      <section id="pricing" className="py-24 border-t border-white/10 tech-grid-bg reveal-on-scroll" style={{ padding: '96px 0 80px 0', position: 'relative', zIndex: 1 }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, maxWidth: 1000, margin: '0 auto', position: 'relative', top: '-20px' }}>
      ...
      <footer style={{ borderTop: '1px solid var(--border)', padding: '80px 0 40px' }}>
        <div className="container">
          {/* Top */}
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '40px 24px', marginBottom: 80 }} className="footer-grid">
            <div>
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 28, flexWrap: 'wrap' }}>
                {[
                  ...
                  { icon: <Instagram size={18} />, href: 'https://instagram.com/owatech.ai', color: '#E1306C', name: 'Instagram' },
