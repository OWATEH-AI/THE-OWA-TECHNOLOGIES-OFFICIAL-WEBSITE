...
const App: React.FC = () => {
  ...
  const testimonials: Testimonial[] = [
    // --- PARTNERS ---
    {
      quote: "Our creative hub at Artgalzim Center is now a global destination. OWA Technologies' digital strategy has put Domboshava's art scene on the world map.",
      name: "Artgalzim Center",
      role: "Creative Arts & Gallery Partner",
      rating: 5,
      isPartner: true,
      image: "/ARTGALZIM/artgalzim_logo.jpg"
    },
    {
  ...
  const osixImages = [
    ...
    '/OSIX/ChatGPT%20Image%20Mar%203,%202026,%2010_32_22%20AM.png',
    '/OSIX/diHPYGSCyNdqdo7SHr5FTY-1200-80.jpg',
    '/OSIX/FB_IMG_1730127872443_(1)_(1).jpg',
    '/OSIX/hands-holding-neon-sign%20(1).jpg',
    ...
    '/OSIX/WhatsApp%20Image%202025-07-14%20at%2015.10.20.jpeg',
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '40px 24px', marginBottom: 60 }} className="footer-grid">
            <div>
              ...
              <div className="social-row-balanced" style={{ display: 'flex', justifyContent: 'flex-start', marginTop: 28, flexWrap: 'wrap', gap: 12 }}>
                {[
