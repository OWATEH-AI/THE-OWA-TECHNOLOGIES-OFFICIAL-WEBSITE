    ...
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div className={wrapClass}>
            ...
            <motion.div
                ...
                className="stack-on-mobile"
                style={{ background: 'linear-gradient(135deg, rgba(249,115,22,0.05), rgba(249,115,22,0.02))', border: '1px solid rgba(249,115,22,0.15)', borderRadius: 24, padding: '52px 44px', marginBottom: 48, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}
            >
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
