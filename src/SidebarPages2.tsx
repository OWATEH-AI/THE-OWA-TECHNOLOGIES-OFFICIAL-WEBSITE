...
const wrap = { maxWidth: 1200, margin: '0 auto', padding: '60px 40px' };
...
const TabBtn: React.FC<{ active: boolean; label: string; icon: React.ReactNode; onClick: () => void }> = ({ active, label, icon, onClick }) => (
    <button onClick={onClick} style={{
        display: 'flex', alignItems: 'center', gap: 10, padding: '14px 28px', borderRadius: 10, cursor: 'pointer', transition: 'all 0.25s', border: active ? '1px solid rgba(37,99,235,0.5)' : '1px solid rgba(255,255,255,0.08)',
        background: active ? 'rgba(37,99,235,0.15)' : 'rgba(255,255,255,0.03)', color: active ? '#60a5fa' : 'rgba(255,255,255,0.6)', fontWeight: 700, fontSize: '0.82rem', letterSpacing: '0.08em', textTransform: 'uppercase' as const,
    }}>{icon} {label}</button>
);
            ...
            <div style={wrap}>
                ...
                {tab === 'teachers' ? (
                    <motion.div key="teachers" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                        {/* Teacher Hero Banner */}
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 32, marginBottom: 48, alignItems: 'center' }}>
                            ...
                            <div style={{ background: 'linear-gradient(135deg, rgba(37,99,235,0.12), rgba(16,185,129,0.08))', border: '1px solid rgba(37,99,235,0.2)', borderRadius: 20, padding: '48px 40px', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    ...
                    <motion.div key="students" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                        {/* Student Hero Banner */}
                        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32, marginBottom: 48, alignItems: 'center' }}>
                            <div style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.12), rgba(37,99,235,0.08))', border: '1px solid rgba(124,58,237,0.2)', borderRadius: 20, padding: '48px 40px', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
    ...
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
                ...
                {[
                    {
                        images: [
                            ...
                            '/assets/owa_blogs/WhatsApp Image 2025-07-14 at 15.10.20.jpeg',
                            '/assets/owa_blogs/media_1e9527932a5ecf365f8b5c3431cb2ba1fcb038d74.png'
                        ],
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, ease: smoothEasing }}
                style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: '48px 40px', marginBottom: 32, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}
            >
            ...
            >
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                        <div style={{ width: 52, height: 52, borderRadius: 12, background: 'linear-gradient(135deg, rgba(37,99,235,0.3), rgba(37,99,235,0.1))', border: '1px solid rgba(37,99,235,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#60a5fa' }}><Wifi size={22} /></div>
                        <div><span style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.1em', color: '#4ade80', textTransform: 'uppercase' as const }}>Authorized Reseller</span><h2 style={{ fontSize: '1.4rem', fontWeight: 800 }}>SpaceX Starlink</h2></div>
                    </div>
                    <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: 1.8, fontSize: '0.95rem', marginBottom: 20 }}>OWA Technologies is an official authorized Starlink reseller in Zimbabwe. We provide hardware sales, professional installation, alignment, and enterprise-grade connectivity solutions for businesses requiring reliable high-speed internet.</p>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                        {['Hardware Sales', 'Professional Installation', 'Enterprise Setup', 'Network Optimization'].map((t, i) => (
                            <span key={i} style={{ padding: '5px 14px', borderRadius: 99, fontSize: '0.72rem', fontWeight: 600, background: 'rgba(37,99,235,0.1)', border: '1px solid rgba(37,99,235,0.2)', color: '#60a5fa' }}>{t}</span>
                        ))}
                    </div>
                </div>
                <div style={{ background: 'rgba(37,99,235,0.06)', border: '1px solid rgba(37,99,235,0.12)', borderRadius: 16, padding: '32px', textAlign: 'center' }}>
                    <Wifi size={48} color="#60a5fa" style={{ marginBottom: 16 }} />
                    <h3 style={{ fontSize: '1.4rem', fontWeight: 900, marginBottom: 8 }}>STARLINK</h3>
                    <p style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.4)', marginBottom: 20 }}>High-Speed Satellite Internet by SpaceX</p>
                    <a href="https://wa.me/263772479492?text=Hello%20OWA%20Technologies%2C%20I%20am%20interested%20in%20getting%20a%20Starlink%20satellite%20internet%20quote.%20Please%20share%20pricing%2C%20coverage%20details%2C%20and%20installation%20information%20for%20my%20area.%20Thank%20you!" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: '0.75rem', fontWeight: 700, color: '#60a5fa', letterSpacing: '0.08em', textTransform: 'uppercase' as const }}>Get a Quote <ChevronRight size={13} /></a>
                </div>
            </motion.div>
            ...
            >
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                        <div style={{ width: 52, height: 52, borderRadius: 12, background: 'linear-gradient(135deg, rgba(168,85,247,0.3), rgba(168,85,247,0.1))', border: '1px solid rgba(168,85,247,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#a78bfa' }}><Palette size={22} /></div>
                        <div><span style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.1em', color: '#a78bfa', textTransform: 'uppercase' as const }}>Media & Branding Partner</span><h2 style={{ fontSize: '1.4rem', fontWeight: 800 }}>GANDS ARTS MEDIA</h2></div>
                    </div>
                    <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: 1.8, fontSize: '0.95rem', marginBottom: 20 }}>Our official media and branding partner. GANDS ARTS MEDIA handles all visual identity, professional photography, AI video advertisements, and legal documentation services for OWA clients. Together, we deliver complete corporate identity packages.</p>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                        {['Logo Design', 'Company Profiles', 'Photography', 'Video Ads', 'Business Cards', 'Legal Documents'].map((t, i) => (
                            <span key={i} style={{ padding: '5px 14px', borderRadius: 99, fontSize: '0.72rem', fontWeight: 600, background: 'rgba(168,85,247,0.1)', border: '1px solid rgba(168,85,247,0.2)', color: '#a78bfa' }}>{t}</span>
                        ))}
                    </div>
                </div>
                <div style={{ background: 'rgba(168,85,247,0.06)', border: '1px solid rgba(168,85,247,0.12)', borderRadius: 16, padding: '32px', textAlign: 'center' }}>
                    <Palette size={48} color="#a78bfa" style={{ marginBottom: 16 }} />
                    <h3 style={{ fontSize: '1.4rem', fontWeight: 900, marginBottom: 8 }}>GANDS ARTS MEDIA</h3>
                    <p style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.4)', marginBottom: 20 }}>Corporate Identity & Professional Media</p>
                    <a href="https://wa.me/263772479492?text=Hello%20OWA%20Technologies%2C%20I%20am%20interested%20in%20enquiring%20about%20GANDS%20ARTS%20MEDIA%20services%20-%20specifically%20for%20branding%2C%20media%20production%2C%20or%20corporate%20identity%20design.%20Please%20send%20me%20a%20portfolio%20and%20pricing%20information.%20Thank%20you!" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: '0.75rem', fontWeight: 700, color: '#a78bfa', letterSpacing: '0.08em', textTransform: 'uppercase' as const }}>Enquire <ChevronRight size={13} /></a>
                </div>
            </motion.div>
            ...
            >
                ...
                <div style={{ borderRadius: 20, overflow: 'hidden', position: 'relative', height: 460, border: '1px solid rgba(249,115,22,0.2)', boxShadow: '0 20px 40px rgba(0,0,0,0.4)' }}>
...
const DocSection: React.FC<{ num: string; title: string; cards: { heading: string; text: string }[] }> = ({ num, title, cards }) => (
    <div style={{ marginBottom: 48 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: cards.length > 1 ? '1fr 1fr' : '1fr', gap: 20 }}>
            {cards.map((c, i) => (
...
export const AboutOWAPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            {/* CTA */}
            <div style={{ background: 'linear-gradient(135deg, #1d4ed8, #2563EB)', borderRadius: 20, padding: '60px 40px', textAlign: 'center', marginTop: 20 }}>
...
export const ReferralPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={{ ...wrap, paddingTop: 20 }}>
            ...
            {/* Commission Rates */}
            <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: '40px', marginBottom: 40 }}>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 800, marginBottom: 24 }}>Industry-Leading Commissions</h3>
                {[
                    ...
                    <div key={i} style={{ display: 'grid', gridTemplateColumns: '200px 150px 1fr', gap: 20, padding: '18px 0', borderBottom: '1px solid rgba(255,255,255,0.05)', alignItems: 'center' }}>
                        <span style={{ fontWeight: 700 }}>{r.tier}</span>
                        <span style={{ fontWeight: 800, color: '#4ade80' }}>{r.rate}</span>
                        <span style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.55)' }}>{r.desc}</span>
                    </div>
                ))}
            </div>

            {/* Loyalty Discounts */}
            <div style={{ background: 'linear-gradient(135deg, rgba(37,99,235,0.1), rgba(0,0,0,0.4))', border: '1px solid rgba(37,99,235,0.2)', borderRadius: 20, padding: '40px', marginBottom: 40 }}>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 800, marginBottom: 24 }}>Loyalty Rewards & Organization Discounts</h3>
                {[
                    ...
                    <div key={i} style={{ display: 'grid', gridTemplateColumns: '200px 150px 1fr', gap: 20, padding: '18px 0', borderBottom: '1px solid rgba(255,255,255,0.05)', alignItems: 'center' }}>
                        <span style={{ fontWeight: 700 }}>{r.tier}</span>
                        <span style={{ fontWeight: 800, color: '#60a5fa' }}>{r.discount}</span>
                        <span style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.55)' }}>{r.desc}</span>
                    </div>
                ))}
            </div>
...
export const WebDevPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            <div style={{ height: 450, borderRadius: 24, overflow: 'hidden', marginBottom: 52, border: '1px solid rgba(255,255,255,0.08)' }}>
                <Slideshow images={[
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginBottom: 48 }}>
                {[
                    { title: 'Standard Presence', price: '$499', features: ['Responsive Design', 'Contact Forms', 'SEO Setup', '1 month support'] },
                    { title: 'Business Pro', price: '$1,299', features: ['AI Chatbot Integration', 'CMS Control Panel', 'Analytics Dashboard', 'Speed Optimization'] },
                    { title: 'Enterprise Hub', price: 'Custom', features: ['Full Neural Integration', 'Custom CRM/API', 'Dedicated Server', 'Priority Support'] },
                ].map((tier, i) => (
                    <div key={i} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16, padding: '32px 28px' }}>
                        <h4 style={{ fontWeight: 800, color: '#60a5fa', marginBottom: 8 }}>{tier.title}</h4>
                        <div style={{ fontSize: '1.8rem', fontWeight: 900, marginBottom: 20 }}>{tier.price}</div>
                        {tier.features.map((f, j) => (
                            <div key={j} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)', marginBottom: 12 }}>
                                <CheckCircle size={14} color="#60a5fa" /> {f}
                            </div>
                        ))}
                    </div>
                ))}
...
export const AIAgentsPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            <div style={{ height: 400, borderRadius: 24, overflow: 'hidden', marginBottom: 52, border: '1px solid rgba(255,255,255,0.08)' }}>
                <Slideshow images={[
...
export const StarlinkPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, marginBottom: 52, alignItems: 'center' }}>
            ...
            <div style={{ gridTemplateColumns: 'repeat(3, 1fr)', display: 'grid', gap: 20, marginBottom: 52 }}>
                {[
                    ...
                    <div key={i} style={{ height: 200, borderRadius: 16, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)' }}>
...
export const CorporatePage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32, marginBottom: 52, alignItems: 'center' }}>
                <div style={{ borderRadius: 20, overflow: 'hidden', height: 340, border: '1px solid rgba(255,255,255,0.08)' }}>
                    <Slideshow images={[
                ...
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: '40px', textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    <h3 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: 20 }}>Complete Identity Packages</h3>
                    <p style={{ color: 'rgba(255,255,255,0.5)', marginBottom: 32 }}>Empower your business with a visual strategy designed for the AI era. From founding documents to professional media assets.</p>
                    <div style={{ display: 'flex', justifyContent: 'center', gap: 16 }}>
                        <a href="https://wa.me/263772479492?text=Hello%20OWA%20Technologies%2C%20I%20would%20like%20to%20view%20your%20corporate%20branding%20and%20media%20portfolio.%20Please%20share%20examples%20of%20your%20previous%20work%20in%20logo%20design%2C%20photography%2C%20and%20video%20production.%20Thank%20you!" target="_blank" rel="noreferrer" className="btn btn-outline" style={{ fontSize: '0.8rem' }}>View Portfolio</a>
                        <a href="https://wa.me/263772479492?text=Hello%20OWA%20Technologies%2C%20I%20am%20requesting%20a%20quote%20for%20a%20complete%20corporate%20identity%20package%20-%20including%20logo%20design%2C%20branding%20materials%2C%20and%20professional%20media%20assets.%20Please%20share%20your%20pricing%20tiers.%20Thank%20you!" target="_blank" rel="noreferrer" className="btn btn-primary" style={{ background: '#a78bfa', borderColor: '#a78bfa', fontSize: '0.8rem' }}>Request Quote</a>
                    </div>
                </div>
            </div>
        </div>
...
const GadgetCarousel: React.FC = () => {
    ...
    const gadgets = [
        ...
        },
        {
            ...
            price: 'Affordable Prices',
            image: '/assets/owa_blogs/xiaomi_tv_2026.jpg',
    ...
    return (
        <div style={{ marginBottom: 60 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, minHeight: 500, alignItems: 'center', marginBottom: 40 }}>
                <motion.div
                    key={activeIndex}
                    initial={{ opacity: 0, x: -50 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6, ease: 'easeOut' }}
                    style={{ position: 'relative', borderRadius: 24, overflow: 'hidden', height: 420, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.02)' }}
                >
                ...
                >
                    <h3 style={{ fontSize: '2.5rem', fontWeight: 900, letterSpacing: '-0.03em', marginBottom: 8, color: activeGadget.color }}>
                        {activeGadget.title}
                    </h3>
                    <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.5)', marginBottom: 24 }}>
                        {activeGadget.subtitle}
                    </p>
                    <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, marginBottom: 24 }}>
                        {activeGadget.description}
                    </p>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 32 }}>
                        {activeGadget.specs.map((spec, i) => (
                            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', background: 'rgba(255,255,255,0.03)', borderRadius: 10, border: '1px solid rgba(255,255,255,0.06)' }}>
                                <CheckCircle size={16} color={activeGadget.color} />
                                <span style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.8)' }}>{spec}</span>
                            </div>
                        ))}
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                        ...
                        <a href={`https://wa.me/263772479492?text=Hello%20OWA%20Technologies%2C%20I%20am%20interested%20in%20the%20${encodeURIComponent(activeGadget.title)}%20priced%20at%20${encodeURIComponent(activeGadget.price)}.%20Please%20share%20availability%2C%20specifications%2C%20and%20any%20current%20offers.%20Thank%20you!`} target="_blank" rel="noreferrer" style={{ padding: '14px 32px', background: activeGadget.color, color: '#fff', borderRadius: 12, fontWeight: 700, fontSize: '0.9rem', textDecoration: 'none' }}>
                            Inquire Now
                        </a>
                    </div>
                </motion.div>
...
export const GadgetPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            {/* Quick Stats */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 24, marginBottom: 48, padding: '32px', background: 'rgba(255,255,255,0.02)', borderRadius: 20, border: '1px solid rgba(255,255,255,0.06)' }}>
                {[
    ...
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            <div style={{ marginBottom: 60 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 40 }}>
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
            ...
            <div style={{ height: 400, borderRadius: 24, overflow: 'hidden', marginBottom: 60, border: '1px solid rgba(255,255,255,0.08)' }}>
                <Slideshow images={[
            ...
            <div style={{ marginBottom: 60 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 32 }}>
                    <div style={{ width: 48, height: 48, borderRadius: 12, background: 'rgba(37,99,235,0.1)', border: '1px solid rgba(37,99,235,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#60a5fa', fontSize: '0.82rem', fontWeight: 900 }}>02</div>
                    <h2 style={{ fontSize: '1.1rem', fontWeight: 800, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#60a5fa' }}>Ecosystem Targets</h2>
                </div>
