...
const PageHero: React.FC<{ badge: string; title: string; sub: string }> = ({ badge, title, sub }) => (
    <div style={{ padding: '60px 0 48px', borderBottom: '1px solid rgba(255,255,255,0.06)', maxWidth: 1200, margin: '0 auto', paddingLeft: 40, paddingRight: 40 }}>
        ...
        <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.6rem)', fontWeight: 900, letterSpacing: '-0.04em', marginBottom: 20 }}
...
const UseCaseCard: React.FC<{ icon: React.ReactNode; sector: string; problems: string[]; solutions: string[]; outcome: string }> =
    ({ icon, sector, problems, solutions, outcome }) => (
        <motion.div
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(200px, 1fr) 1.2fr 1.2fr 1.2fr', gap: 0 }}>
                <div style={{ padding: '40px 24px', background: 'rgba(255,255,255,0.03)', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
                    <motion.div
...
const PricingBlock: React.FC<{
    ...
    >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0,1fr))', gap: 10, marginBottom: 10 }}>
            <div style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#60a5fa', padding: '0 24px 12px' }}>Capability</div>
            <div style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#60a5fa', padding: '0 24px 12px' }}>Description</div>
            <div style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#60a5fa', textAlign: 'right', padding: '0 24px 12px' }}>Estimate Range</div>
        </div>
...
const PriceRow: React.FC<{ cap: string; desc: string; price: string; priceColor?: boolean; sub?: string }> =
    ({ cap, desc, price, priceColor = true, sub }) => (
        <div style={{
            ...
            <div>
                <p style={{ fontWeight: 600, fontSize: '0.95rem' }}>{cap}</p>
                {sub && <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.4)', marginTop: 2 }}>{sub}</p>}
            </div>
            <p style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.55)' }}>{desc}</p>
            <p style={{ textAlign: 'right', fontWeight: 700, color: priceColor ? '#60a5fa' : 'rgba(255,255,255,0.8)' }}>{price}</p>
        </div>
    );
...
export const SolutionsPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            {/* Quote banner */}
            <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32, marginBottom: 60, alignItems: 'center' }}>
                <div style={{ background: 'rgba(37,99,235,0.08)', border: '1px solid rgba(37,99,235,0.15)', borderRadius: 16, padding: '36px 40px', height: '100%', display: 'flex', alignItems: 'center' }}>
            ...
            {[
                ...
                <div key={i} style={{
                    ...
                    padding: '48px 0', borderBottom: '1px solid rgba(255,255,255,0.05)',
                    alignItems: 'start',
                }}>
                    <div>
                        <div style={{
    ...
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 1.2fr', gap: 40, marginBottom: 60, alignItems: 'center', background: 'linear-gradient(135deg, rgba(16,185,129,0.05), transparent)', border: '1px solid rgba(16,185,129,0.1)', borderRadius: 24, padding: '40px' }}>
                <div>
...
export const AcademyPage: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            {/* Academic Visuals */}
            <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 24, marginBottom: 72 }}>
                <div style={{ height: 400, borderRadius: 24, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)' }}>
                    <Slideshow images={[
                ...
                <div style={{ borderRadius: 24, overflow: 'hidden', height: 400, border: '1px solid rgba(255,255,255,0.08)', position: 'relative' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 48 }}>
                <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16, padding: '32px 28px' }}>
                    ...
                    <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                        {[
                            { icon: <WhatsAppIcon size={20} />, href: 'https://wa.me/263772479492', label: 'WhatsApp' },
                            { icon: <Instagram size={20} />, href: 'https://instagram.com/owatech.ai', label: 'Instagram' },
    ...
    <PageOverlay open={open} onClose={onClose}>
        ...
        <div style={wrap}>
            ...
            <section style={{ marginBottom: 80 }}>
                ...
                <div style={{ height: 350, borderRadius: 24, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }}>
                    <Slideshow images={[
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: 40, marginBottom: 80 }}>
                {/* BBF College */}
            ...
            <div style={{ textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 60 }}>
